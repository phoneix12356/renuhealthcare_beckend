  ...
  useEffect(() => {
    ...
    gsap.from(".card", {
      ...
      scrollTrigger: {
        trigger: ".events-box",
        scroller: "body",
        start: "top bottom", // Start when the top of the events box reaches the bottom of the viewport
        end: "bottom top",
        scrub: true,
      },
    });

    // GSAP animation for event heading
    gsap.to(".event-heading", {
      ...
      scrollTrigger: {
        trigger: ".events-box",
        scroller: "body",
        start: "top center", // Start when the top of the events box reaches the center of the viewport
        end: "bottom top",
        scrub: true,
      },
    });
