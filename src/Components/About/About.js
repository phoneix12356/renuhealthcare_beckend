    ...
    <div className="sm:w-11/12 m-auto">
      ...
      <div className="bg-gray-100 overflow-hidden">
        ...
        <div id="5" className="lg:px-20 flex flex-col md:flex-row gap-6 my-10 mx-4 overflow-hidden">
          {/* Example of Review */}
          {[
            { name: "Himanshu", amount: "₹500", img: "/About-img/dp2.jpeg" },
            { name: "Geetika", amount: "₹300", img: "/About-img/dp3.jpg" },
            { name: "Farhan", amount: "₹400", img: "/About-img/dp1.jpeg" },
          ].map((donor, index) => (
            <div
              key={index}
              className="flex flex-col md:flex-row items-center bg-white mb-8 shadow-lg rounded-lg p-6"
            >
              <img
              ...
              />
              <div>
                <p className="text-xl font-semibold">{donor.name}</p>
